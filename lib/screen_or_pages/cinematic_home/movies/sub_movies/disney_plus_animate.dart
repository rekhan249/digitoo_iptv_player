...
class DisneyPlusAnimationStudiosCollection extends StatelessWidget {
  const DisneyPlusAnimationStudiosCollection({super.key});
              ...
              builder:
                ...
                final listMovies = snapshot.data!
                    .where((element) => element!.categoryName!
                        .contains("Disney Plus Animation Studios Collection"))
                    .toList();
