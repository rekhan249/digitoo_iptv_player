...
class MartinScorseseDanielDaylewisCollection extends StatelessWidget {
  const MartinScorseseDanielDaylewisCollection({super.key});
          ...
          child: FutureBuilder<List<LiveCategories?>>(
              ...
              builder:
                ...
                final listMovies = snapshot.data!
                    .where((element) => element!.categoryName!.contains(
