...
class IndianaJonesTheCompleteAdventure extends StatelessWidget {
  const IndianaJonesTheCompleteAdventure({super.key});
              ...
              builder:
                ...
                final listMovies = snapshot.data!
                    .where((element) => element!.categoryName!
                        .contains("Indiana Jones The Complete Adventure"))
                    .toList();
