              ...
              child: Row(
                ...
                children: [
                  Row(children: [
                    ...
                    const Text(
                      "$deviceOptions | Settings| Time Format",
                      style: TextStyle(
                          color: whiteColors,
                          fontSize: 16,
                ...
                children: [
                  const Text("Time Format",
                      style: TextStyle(
                          ...
                          fontWeight: FontWeight.bold)),
                  GetBuilder(
                      init: TimeFormatController(),
                      builder: (controller) {
                        return ListView(
                            padding: const EdgeInsets.all(0),
                            shrinkWrap: true,
                            children: timeFormatModelList
                                .map((e) => RadioListTile(
                                      controlAffinity:
                                      ...
                                      title: Text(e.title,
                                          style: const TextStyle(
                                              ...
                                              fontSize: 16)),
                                      value: e,
                                      groupValue: controller.timeFormatModel,
                                      onChanged: (val) {
                                        controller.seletionTimeFormat(val!);
                                      },
                                    ))
                                .toList());
                      }),
